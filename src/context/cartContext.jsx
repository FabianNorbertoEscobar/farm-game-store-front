...
/**
 * CartContext - Context para manejar el carrito de compras
 * Proporciona todas las funcionalidades necesarias para gestionar productos
 * en el carrito de la tienda de juegos de granja
 */
...
export function CartProvider({ children }) {
     ...
     * @param {Object} item - Producto a agregar (debe tener id, title, price, img, category)
     ...
     * @param {number} newCount - Nueva cantidad (si es 0 o menor, elimina el item)
     */
 ...
 * Facilita el acceso al contexto del carrito desde cualquier componente
